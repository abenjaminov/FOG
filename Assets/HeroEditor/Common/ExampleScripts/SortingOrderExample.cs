...
namespace Assets.HeroEditor.Common.ExampleScripts
{
	...
	public class SortingOrderExample
	{
		...
		/// </summary>
		public static void OrderByIndex(CharacterScripts.Character front, CharacterScripts.Character back)
		{
		...
		/// </summary>
		public static void OrderByZ(CharacterScripts.Character front, CharacterScripts.Character back)
		{
		...
		/// </summary>
		public void SetupSortingOrderByY(List<CharacterScripts.Character> character)
		{
