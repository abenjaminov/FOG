...
namespace Assets.HeroEditor.Common.ExampleScripts
{
	...
	{
		public static void SaveToPlayerPrefs(CharacterScripts.Character character)
		{
		...
		public static CharacterScripts.Character CreateCharacter(GameObject prefab, CharacterData characterData)
		{
			var character = Object.Instantiate(prefab).GetComponent<CharacterScripts.Character>();
